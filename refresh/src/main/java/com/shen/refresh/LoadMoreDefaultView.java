...
public class LoadMoreDefaultView extends BaseLoadMoreView {


    @Override
    public RecyclerView.ViewHolder onCreateItemView(ViewGroup parent) {
        LoadMoreViewHolder loadMoreHolder = new LoadMoreViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.loading_more_default_layout, parent, false));
